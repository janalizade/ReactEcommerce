    ...
    return(
     <div className='row mt-5 justify-content-center'>
         <div className="col-mod-6">
           ...
           />
           <input type="text" className='form-control' placeholder='Item Price' value={itemprice} 
             onChange={(e)=>{setitemprice(e.target.value)}}
             />
             <input type="text" className='form-control' placeholder='Item Image' value={itemimage} 
